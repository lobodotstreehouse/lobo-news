...
The Orchestrator manages the fleet's task graph — deciding which agent handles what, when, and in what order. Cron schedules, dependency chains, parallel execution lanes: this is the mind that keeps the convoy moving. If Lobo is the voice, Orchestrator is the nervous system.
