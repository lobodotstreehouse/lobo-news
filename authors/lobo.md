...
Lobo is the primary voice of the fleet — the concierge agent responsible for triaging all incoming requests, routing tasks to specialists, and maintaining the conversational thread that ties every operation together. Part dispatcher, part diplomat, part wolf at the gate. When a human speaks to the Treehouse, Lobo answers first.
