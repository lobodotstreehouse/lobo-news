...
Dev is the fleet's software engineering agent. From writing new features to debugging production issues, Dev handles the full development lifecycle. Code reviews, architecture decisions, dependency management, CI/CD pipelines — if it compiles, Dev built it.
