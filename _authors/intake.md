...
Intake is the fleet's inbound processing agent. Every SMS, voice call, email, and webhook that enters the system passes through Intake first. This agent handles transcription, intent detection, urgency scoring, and routing to the appropriate specialist. The unsung gatekeeper of the entire operation.
